...
let madoka = new Entries('Puella Magi Madoka Magica', 'There is an old adage that you have to watch at least three episodes of a show before you can pass judgment&mdash;this rule of thumb may as well have been invented for Madoka Magica. It sits firmly in the tradition of magical girl anime, making frequent reference to Cardcaptor Sakura, Magical Girl Lyrical Nanoha, and everything else. But Madoka Magica takes a surprising turn, and in the end, it somehow manages both to treasure and to subvert the genre to which it belongs. This is quite possibly the best anime ever made.', 'madoka-hidoi.png', 'Madoka comments on the destruction she sees in a dream.')
